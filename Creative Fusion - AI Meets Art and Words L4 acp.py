...
# - asks for a folder path (default "images")
# - processes all .jpg/.jpeg/.png in that folder
# - prints "Processing:" and "Caption:"
# - writes captions_summary.txt in the same folder
